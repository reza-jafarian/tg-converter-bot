...
from src.utils.functions import extract_zip_file, process_method, check_step
    ...
    async def process(event):
        ...
        if check_step(step = user_data.step):
            if event.message.media.document.mime_type == 'application/zip':
                ...
                extract_zip_file(zip_path = file_name, dest_folder = f'sessions/{user.id}/{random_uniqe_code}')
